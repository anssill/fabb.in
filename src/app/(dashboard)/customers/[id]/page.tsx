              ...
              <div className="flex items-start gap-4">
                <Avatar className="w-16 h-16">
                  {customer.profile_photo_url ? (
                    <img src={customer.profile_photo_url} alt={customer.name} className="w-full h-full object-cover rounded-full" />
                  ) : (
                    <AvatarFallback className="text-lg bg-violet-100 text-violet-700">{initials}</AvatarFallback>
                  )}
                </Avatar>
