    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.7fr_1fr]">
        <div className="space-y-5">
          <Card className="overflow-hidden"><CardContent className="p-0"><div className="relative aspect-[16/8] bg-muted">{item.cover_image_url ? <Image unoptimized src={item.cover_image_url} alt={item.name} fill priority sizes="(max-width: 1024px) 100vw, 66vw" className="object-cover" /> : <div className="grid h-full place-items-center"><Package className="h-16 w-16 text-muted-foreground/30" /></div>}</div></CardContent></Card>
