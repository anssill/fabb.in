...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'manage_operation_settings', label: 'Operation settings', description: 'Enable or hide store operation workflow sections' },
...
export const ROUTE_PERMISSION_MAP: Record<string, PermissionKey> = {
  ...
  '/settings/operations': 'manage_operation_settings',
